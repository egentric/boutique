                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                                    ...
                                    <img src="/storage/uploads/{{ Auth::user()->picture }}" alt="" width="40">
                                    {{ Auth::user()->pseudo }}
                                </a>
...
<div class="row">
    ...
    <div class="container-fluid">
                            ...
                            <ul class="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                                <li class="w-100">
                                    <a href="{{ route('articles.index')}}" class="nav-link px-0 text-light"><i
                                            class="fs-4 bi bi-tag"></i> <span
                                            class="d-none d-sm-inline">Articles</span></a>
                                </li>
                                <li>
                                    <a href="{{ route('promos.index')}}" class="nav-link px-0 text-light"><i
                                            class="fs-4 bi bi-star"></i> <span
                                            class="d-none d-sm-inline">Promos</span></a>
                                </li>
                                <li>
                                    <a href="{{ route('ranges.index')}}" class="nav-link px-0 text-light"><i
                                            class="fs-4 bi bi-bookmarks"></i> <span
                                            class="d-none d-sm-inline">Catégories</span></a>
                                </li>
                                <li>
                                    <a href="{{ route('sizes.index')}}" class="nav-link px-0 text-light"><i
                                            class=" fs-4 bi bi-aspect-ratio"></i> <span
                                            class="d-none d-sm-inline">Tailles</span></a>
                                </li>
                            </ul>
                        </li>
        ...
        --}}
            ...
            <div class="col-auto col-md-9 col-xl-10 px-sm-10 px-0 mt-5">
                <div class="row  flex-nowrap">
                    @yield('content')
                </div>
            </div>
